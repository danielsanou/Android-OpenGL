// source : http://fractiousg.blogspot.fr/2012/04/rendering-text-in-opengl-on-android.html
...
package com.daniel.sanou.android.opengl.objects.others.text.utils;
...
public class GLText {
   ...
   public GLText(GL10 gl, AssetManager assets) {
      ...
      scaleX = 0.01f;                                  // Default Scale = 1 (Unscaled)
      scaleY = 0.01f;                                  // Default Scale = 1 (Unscaled)
      spaceX = 0.0f;
   ...
   public void drawTexture(int width, int height)  {
      ...
      batch.drawSprite( textureSize , height - (textureSize), textureSize, textureSize, textureRgn );  // Draw
      batch.endBatch();                               // End Batch
   }
